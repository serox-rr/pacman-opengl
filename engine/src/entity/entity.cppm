...
export namespace Engine {
    class Entity {
    public:
        Entity(glm::vec2 position_, float rotation_, double speed_, const std::initializer_list<std::reference_wrapper<const Renderable>> &collidables_, float mass_, const std::shared_ptr<Sprite> &sprite_);
